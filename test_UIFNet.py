...
dataset_path = '/remote-home/cs_tcci_liangbocheng/SOD_Datasets/'

model = SFINet()
model.load_state_dict(torch.load('./models/SFINet/SFINet_V3_EORSSD.pth', map_location=torch.device('cuda:0')))

model.cuda()
model.eval()

test_datasets = ['EORSSD']   # 'ECSSD', 'PASCALS', 'DUT-O', 'HKU-IS', 'DUTS-TE', 'ORSI-4199', 'EORSSD', 'ORSSD'
